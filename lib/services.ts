  ...
  },
  {
    ...
    text: {
      ...
      en: {
        ...
        what: "We design how your wealth is protected and passed on, within the forced heirship rules of Dominican law. Depending on your situation, we combine the Dominican succession planning trust under Law 189-11, the Panamanian private interest foundation under Law 25 of 1995, wills and family holding companies with a family protocol, so your assets reach your loved ones when and how you decide, without disputes or endless probate. When an estate is already open, we settle it amicably whenever possible and in court when necessary.",
        steps: ["Review of your assets, heirs and the countries involved", "Design of the structure: trust, foundation, will or holding company", "Incorporation, transfer of assets and registration of each one"],
        items: ["Succession planning trust (Law 189-11)", "Panamanian private interest foundation", "Wills, gifts and holding companies", "Determination of heirs and partitions"],
      ...
      fr: {
        ...
        what: "Nous organisons la protection et la transmission de votre patrimoine, dans le respect de la réserve héréditaire du droit dominicain. Selon votre situation, nous combinons la fiducie de planification successorale de la loi 189-11, la fondation d'intérêt privé panaméenne de la loi 25 de 1995, le testament et les sociétés holding dotées d'un pacte familial, afin que vos biens reviennent aux vôtres au moment et aux conditions que vous choisissez, sans conflit ni succession interminable. Lorsque la succession est déjà ouverte, nous la réglons à l'amiable chaque fois que possible, et en justice si nécessaire.",
        steps: ["Diagnostic du patrimoine, des héritiers et des pays concernés", "Conception de la structure : fiducie, fondation, testament ou société", "Constitution, apport des biens et inscription de chacun"],
        items: ["Fiducie de planification successorale (loi 189-11)", "Fondation d'intérêt privé au Panama", "Testaments, donations et sociétés holding", "Détermination des héritiers et partages"],
