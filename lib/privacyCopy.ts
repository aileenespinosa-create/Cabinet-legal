...
export const PRIVACY_COPY: Record<Lang, { metaTitle: string; title: string; updated: string; intro: string; sections: Section[] }> = {
  es: {
    ...
    intro:
      "Cabinet Legal protege los datos personales que recibe a través de este sitio web conforme a la Ley Orgánica núm. 172-13 sobre Protección Integral de los Datos Personales de la República Dominicana. Esta política explica qué datos recogemos, para qué los usamos y cuáles son tus derechos.",
    sections: [
      ...
      ["Datos que recogemos", [
        "Los que nos facilitas en los formularios: nombre, correo electrónico, teléfono, país de residencia, área de interés y el contenido de tu mensaje.",
        "En la sección Únete, además, tu currículum y los datos profesionales que incluyas.",
        "Datos de navegación agregados, mediante Google Analytics, para conocer cómo se usa el sitio.",
      ]],
      ["Para qué los usamos", [
        "Responder a tus consultas y preparar propuestas de servicios.",
        "Enviarte la guía descargable y, si lo aceptaste, comunicaciones ocasionales de la firma. Puedes darte de baja en cualquier momento desde el enlace de cada correo.",
        "Evaluar tu candidatura en los procesos de selección.",
        "Mejorar el funcionamiento y el contenido del sitio.",
      ]],
      ["Base del tratamiento", ["Tu consentimiento, otorgado al enviar un formulario, y la necesidad de atender la relación precontractual o profesional que tú mismo inicias."]],
      ["Con quién los compartimos", [
        "No vendemos ni cedemos tus datos. Solo los tratan proveedores que nos prestan servicios técnicos, bajo obligaciones de confidencialidad: Brevo (envío de correos), Vercel (alojamiento del sitio) y Google (analítica).",
        "Algunos de estos proveedores pueden tratar datos fuera de la República Dominicana, con garantías adecuadas de protección.",
      ]],
      ["Cuánto tiempo los conservamos", ["Mientras dure la relación o la finalidad para la que se recogieron. Los currículos se conservan hasta 12 meses para futuras posiciones, salvo que pidas su eliminación antes."]],
      ["Tus derechos", ["Puedes acceder a tus datos, rectificarlos, cancelarlos u oponerte a su tratamiento, y retirar tu consentimiento en cualquier momento, escribiendo a info@cabinetlegal.com.do. Responderemos en los plazos que establece la ley."]],
      ["Secreto profesional", ["La información que compartas sobre un asunto legal está protegida además por el secreto profesional del abogado."]],
