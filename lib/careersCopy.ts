...
> = {
  es: {
    ...
    reasons: [
      ["Mentoría directa", "Trabaja cada asunto junto a un socio, que revisa su trabajo y le ayuda a formar criterio propio."],
      ...
      ["Crecimiento por área", "Doce áreas de práctica para especializarse donde está su vocación."],
    ],
    profilesTitle: "Perfiles que buscamos",
    profiles: [
      ["Abogados asociados", "Con exequátur y experiencia en alguna de nuestras áreas."],
      ["Pasantes de Derecho", "Estudiantes de los últimos años, con interés en aprender en la práctica."],
      ["Equipo administrativo y paralegal", "Gestión de expedientes, trámites y atención al cliente."],
    ],
    noOpening: "¿No encuentra una vacante abierta? Envíenos su CV de todos modos; lo tendremos en cuenta para futuras posiciones.",
    formTitle: "Envíe su candidatura",
    ...
    cvHint: "Arrastre su CV aquí o",
    cvChoose: "seleccione un archivo",
    why: "¿Por qué desea unirse? (breve)",
    consent: "Autorizo a Cabinet Legal a tratar mis datos para este proceso de selección, conforme a su",
    privacyLabel: "política de privacidad",
    privacyHref: "/privacidad",
    submit: "Enviar candidatura",
    sending: "Enviando...",
    sentTitle: "Recibimos su candidatura",
    sentText: "Gracias por su interés en Cabinet Legal. Revisaremos su perfil y nos pondremos en contacto con usted si se ajusta a una posición abierta o futura.",
    errInvalid: "Revise su nombre, su correo, el CV y la casilla de autorización.",
