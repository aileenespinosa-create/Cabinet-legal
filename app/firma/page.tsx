...
export const metadata: Metadata = {
  ...
  openGraph: { title: t.metaTitle, description: t.metaDesc, url: "https://cabinetlegal.com.do/firma", images: ["https://cabinetlegal.com.do/hero-legal.jpg"] },
};

export default function Page() {
  return <FirmaPage lang="es" />;
}
